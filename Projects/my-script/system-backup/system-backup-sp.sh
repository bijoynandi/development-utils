...
# ------
# 1. Make executable:
#    chmod +x system-backup-sp.sh
#
# 2. Dry run (ALWAYS test first!):
#    ./system-backup-sp.sh --dry-run
#
# 3. Actual backup:
#    ./system-backup-sp.sh
#
# 4. With verbose output:
#    ./system-backup-sp.sh --verbose
#
...
#   crontab -e
#   0 2 * * 0 /path/to/system-backup-sp.sh  # Every Sunday at 2 AM
#
# ============================================
...
BACKUP_DEST="/run/media/bijoy/system-backup-sp"
